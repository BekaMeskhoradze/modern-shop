...
class IndexView(TemplateView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if request.headers.get('HX-Request'):
            return TemplateResponse(request, 'core/home_content.html', context)
    ...
    def get(self, request, *args, **kwargs):
        ...
        if request.headers.get('HX-Request'):
            if context.get('show_search'):
                return TemplateResponse(request, 'core/search_input.html', context)
            elif context.get('reset_search'):
                return TemplateResponse(request, 'core/search_button.html', {})
            template = 'core/filter_modal.html' if request.GET.get('show_filter') == 'true' else 'core/catalog.html'
